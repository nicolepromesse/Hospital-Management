...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println(
                    "3. Patient Login & Book Appointment");

            System.out.println(
                    "4. Doctor Login (View Appointments)");
    ...
    static void registerDoctor() {
        ...
        Doctor doctor =
                new Doctor(name, password, specialization);

        userManager.registerDoctor(doctor);
    }
    ...
    static void registerPatient() {
        ...
        Patient patient =
                new Patient(name, password, conditions);
    ...
    static void patientFlow() {
        ...
        Patient patient =
                userManager.loginPatient(name, password);
    ...
    static void doctorFlow() {
        ...
        Doctor doctor =
                userManager.loginDoctor(name, password);

        if (doctor == null) {

            System.out.println(
                    "Doctor name or password is incorrect."
            );
